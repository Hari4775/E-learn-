...
console.log(selecetdCategory,"selected from card")
  ...
  return (
    ...
    onClick={()=>{setSelectedCategory(category?.id)}}
      ...
      type="button"
      className={`${
        category?.id === selecetdCategory ? "category-card selected" : "category-card"
      }`} 
    >
      <div className="icon-wrap"><BriefcaseIcon /></div>
